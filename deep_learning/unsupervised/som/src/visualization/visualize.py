...
def plot_som_heatmap(distance_map, winners, y=None, title="SOM Heatmap"):
...
def plot_anomaly_distribution(anomaly_scores, threshold=None):
...
def plot_feature_importance(som, feature_names):
